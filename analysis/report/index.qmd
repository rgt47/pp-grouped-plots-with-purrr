---
title: "Functional Plot Generation with purrr"
author: "Ronald G. Thomas"
date: today
categories: [r, data-visualization]
description: "I did not really know how to programmatically generate multiple plots from grouped data until I discovered purrr's map2 and pmap functions -- this post walks through the approach step by step using Palmer Penguins."
...
![Functional programming and visualisation.](media/images/ambiance1.png){.img-fluid height=3.5in}
...
strata.](media/images/ambiance2.png){.img-fluid height=3.5in}
...
whole.](media/images/ambiance3.png){.img-fluid height=3.5in}
